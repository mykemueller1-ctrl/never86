# Grok Social Command — operating system

Grok runs one social newsroom. Cursor HQ is the inbox. Myke is the only send/post gate.

## Rule

Draft, queue, learn. Never auto-post, auto-DM, or auto-email.
...
Hunter hunts also call `get_hunter_standup`.

## After a useful Grok session

Update Drive **Never86 HQ Handoff** and `docs/company/intake/GROK_HANDOFF.md` with facts, decisions, and open work. Do not dump the transcript.

## Hard stops

- No auto-post or auto-DM
- No CTAP private numbers in public drafts
