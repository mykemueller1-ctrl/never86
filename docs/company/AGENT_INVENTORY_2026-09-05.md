...
**Cursor cloud:** 147 accessible agents on never86, 1 RUNNING (this rebuild), 3 archived, 0 killed.  
...
| House-code `/portal` | never86 | Only orchestration seat door. | drafted-fail-closed |
...
|---|---|---|
| This rebuild | `Never86 · never86-orchestrator-rebuild-v1` RUNNING | keep (this job) |
