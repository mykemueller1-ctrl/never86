...
**Code governance wire:** [`AGENT_ORCHESTRATION.md`](AGENT_ORCHESTRATION.md) — one agent · one job; public MCP knowledge tools; store memory propose/approve (no mega-agent, no formula forks).
