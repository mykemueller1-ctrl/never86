...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const fixed: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/play`, lastModified: now, changeFrequency: 'weekly', priority: 0.98 },
    { url: `${BASE}/operator`, lastModified: now, changeFrequency: 'weekly', priority: 0.96 },
    { url: `${BASE}/action-shift`, lastModified: now, changeFrequency: 'weekly', priority: 0.95 },
    ...
    { url: `${BASE}/communities`, lastModified: now, changeFrequency: 'weekly', priority: 0.4 },
