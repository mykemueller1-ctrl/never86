  ...
  return (
    <main className="min-h-screen text-ink-800">
      ...
      <article className="max-w-3xl mx-auto px-6 pt-20 pb-20">
        <p className="text-ink-500 text-[12px] font-semibold uppercase tracking-widest mb-5">Case · the correction</p>

        <h1 className="display text-5xl md:text-7xl mb-8 font-mono tabular-nums tracking-tighter">
          <span className="text-ink-400">$8.3M</span>
          <span className="text-ink-300 mx-3">→</span>
          <span className="text-ink-800">$1.81M</span>
        </h1>

        <p className="text-ink-600 text-xl md:text-2xl leading-snug tracking-tight mb-12">
          Every other restaurant tech vendor brags about accuracy gains.
          We did the opposite — we published the correction.
        </p>

        <div className="space-y-7 text-ink-700 text-lg leading-relaxed">
          <p>
            Our first reconciliation for a 16-unit chef-led group put the recovery surface at <span className="font-mono tabular-nums">$8.3M / year</span>. The number was on the screen. It came out of the model. The math was internally consistent.
          </p>
          <p>
            It was also wrong.
          </p>
          ...
          <p>
            We pulled the model down. Re-pulled net sales from the leaf-channel view, de-duplicated. The honest network number came out at <span className="font-mono tabular-nums">$15.72M</span>. The honest recovery surface came out at <span className="font-mono tabular-nums">$1.81M</span> — about 22% of what we&apos;d originally reported.
          </p>
          <p>
            The choice in front of us was simple.
            We could leave the $8.3M number in the deck and never speak of it again — every other vendor in this category would have. Or we could walk it back, in writing, to the design partner who&apos;d already seen the original figure.
          </p>
          <p>
            We walked it back. <span className="text-ink-800 font-semibold">The discipline of correcting your own number down is the product.</span> It&apos;s why the design partner stayed. It&apos;s why the next number we shipped — <span className="font-mono tabular-nums">$15.72M reconciled across 545,677 orders</span> — landed without anyone needing to verify it twice.
          </p>
          <p>
            Every figure that comes out of never86 since then ships tagged.
            <span className="text-success-500 font-semibold"> Verified</span> means we can re-pull it from a primary source and defend it to the penny.
            <span className="text-warning-500 font-semibold"> Estimated</span> means we&apos;ve modeled it from a benchmark or assumption; we name the assumption.
            <span className="text-danger-500 font-semibold"> Unverified</span> means the source isn&apos;t wired yet; the number is illustrative.
          </p>
          <p>
        ...
        <div className="mt-16 pt-10 border-t border-ink-200">
          <p className="text-ink-500 text-[12px] font-semibold uppercase tracking-widest mb-5">Take it for a drive</p>
          <div className="flex flex-wrap items-center gap-3">
            <Link href="/demo/3p-fee-finder" className="btn-primary">Try a free agent</Link>
            <Link href="/operators#talk" className="btn-secondary">15 minutes on your data</Link>
          </div>
        </div>
      </article>
