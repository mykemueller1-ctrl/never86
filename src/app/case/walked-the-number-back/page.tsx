    ...
    <main className="compass min-h-screen">
          ...
          <Link href="/" className="flex items-start gap-4 group">
            ...
            <span>
              <p className="font-serif text-[24px] leading-none text-ink-800">
                Never 86&apos;d <span className="italic text-ink-600">· the correction</span>
              </p>
              <p className="compass-eyebrow-dim mt-2">Restaurant margin intelligence · published case</p>
            </span>
          </Link>
      ...
      <article className="max-w-3xl mx-auto px-6 pt-16 md:pt-20 pb-20">
        ...
        <div className="space-y-7 compass-body text-lg leading-relaxed">
          <p>
            Our first reconciliation for a 16-unit chef-led group put the recovery surface at <span className="font-mono tabular-nums text-ink-800">$8.3M / year</span>. The number was on the screen. It came out of the model. The math was internally consistent.
          </p>
          <p>
            <span className="text-ink-800 font-semibold">It was also wrong.</span>
          </p>
          <p>
          ...
          <p>
            We pulled the model down. Re-pulled net sales from the leaf-channel view, de-duplicated. The honest network number came out at <span className="font-mono tabular-nums text-ink-800">$15.72M</span>. The honest recovery surface came out at <span className="font-mono tabular-nums text-ink-800">$1.81M</span> — about 22% of what we&apos;d originally reported.
          </p>
          <p>
          ...
          <p>
            We walked it back. <span className="text-ink-800 font-semibold">The discipline of correcting your own number down is the product.</span> It&apos;s why the design partner stayed. It&apos;s why the next number we shipped — <span className="font-mono tabular-nums text-ink-800">$15.72M reconciled across 545,677 orders</span> — landed without anyone needing to verify it twice.
          </p>
          <p>
        ...
        <div className="mt-16 pt-10 border-t border-[#e8e8ed]">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <TrackedLink href="/onboard" event="case_bottom_cta_click" meta={{ target: '/onboard', label: '15 minutes on your data', variant: 'secondary' }} className="btn-secondary" style={{ background: 'transparent', borderColor: '#d2d2d7', color: '#1d1d1f' }}>15 minutes on your data</TrackedLink>
          </div>
        </div>
      </article>
      ...
      <footer className="border-t border-[#e8e8ed] py-10 px-6">
        <div className="max-w-3xl mx-auto flex items-center justify-between text-[#6e6e73] text-[12px]">
          ...
          <TrackedLink href="/" event="case_footer_click" meta={{ target: '/', label: 'Home' }} className="hover:text-ink-800 transition-colors">Home</TrackedLink>
        </div>
      </footer>
    </main>
  );
