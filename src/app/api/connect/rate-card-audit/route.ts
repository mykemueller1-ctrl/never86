...
import { runRateCardAudit } from '@/lib/rateCardAuditCsv';
...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = runRateCardAudit(parsed.csv);
    logVisitorEvent({
      eventType: 'connect_agent_run',
      pagePath: '/connect/rate-card-audit',
      agentName: 'Rate Card Audit',
      audience: 'cfo',
