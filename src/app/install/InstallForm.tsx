      ...
      {fromShareToken && (
        <div className="compass-card mb-6" style={{ borderColor: '#0066ff' }}>
          ...
          <p className="compass-body text-sm mt-3">
            Your trial result <span className="font-mono text-white">/trial/run/{fromShareToken}</span> is attached to this install request. Myke will see both in one admin record.
          </p>
        </div>
      )}
