        ...
        <Link href="/" className="flex items-start gap-4 group">
          ...
          <span>
            ...
            <p className="compass-eyebrow-dim mt-2">
              {mode === 'password' ? 'Work email + password' : 'Work email + store name · magic link'}
            </p>
          </span>
        </Link>
      </div>
      ...
      <section className="max-w-md mx-auto px-6 pt-20 md:pt-28">
        ...
        <p className="compass-body text-[15px] mb-8" style={{ color: '#86868b' }}>
          {mode === 'password'
            ...
            : 'Same path as claiming the seat: work email + store name. We send a secure link. Click it — you’re in. Password is optional, one time.'}
        </p>
