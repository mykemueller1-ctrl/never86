...
export const SHARED_SKILL_INSTRUCTIONS = [
  ...
  'Analysis tools (operator-provided data only): analyze_labor, analyze_beverage, convert_uom, analyze_recipe_cost, analyze_vendor_prices, build_action_shift.',
...
export function getNever86SkillPack() {
  ...
  return {
    ...
    knowledge: {
      ...
      analysis: ['analyze_labor', 'analyze_beverage', 'convert_uom', 'analyze_recipe_cost', 'analyze_vendor_prices', 'build_action_shift'],
      publicSurfaces: [
