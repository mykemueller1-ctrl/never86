...
export const OPERATOR_V2_PLATES: readonly OperatorV2Plate[] = [
  {
    ...
    tray: 'labor',
    missingUntil: 'A week photo or file lands. Say if it lives on POS, an app, Sheets, or paper. Labor lives on the schedule.',
    ocrInput: true,
    firstClass: true,
    deferred: false,
  ...
  },
  {
    ...
    tray: 'labor',
    missingUntil: 'Roles named on the card. Punch ≠ schedule. No invented overtime. No hardcoded labor-app path.',
    ocrInput: true,
    firstClass: true,
    deferred: false,
  ...
  },
  {
    ...
    tray: 'food',
    missingUntil: 'A menu photo lands. Top plates only — no full recipe book week 1. No invented plate mix.',
    ocrInput: true,
    firstClass: true,
    deferred: false,
    evidenceKind: 'menu',
  },
  {
    ...
    tray: 'food',
    missingUntil: 'A paper order guide, photo, or print lands. Outside the POS. Invoice ≠ COGS.',
    ocrInput: true,
    firstClass: true,
    deferred: false,
