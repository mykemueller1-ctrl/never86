...
export const AGENT_SPECS: AgentSpec[] = [
  ...
  },
  {
    ...
    intro: 'Five ticket-level signals: void after payment, cash-only voiders, comp abuse, promo stacking, discount after close. Each name gets a composite risk score 0-100, sorted by severity.',
    catches: [
    ...
    sampleSignal: 'James Wilson · 6 void-after-payment tickets · 100% cash tender · risk score 68.',
