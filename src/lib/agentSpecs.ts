...
export const AGENT_SPECS: AgentSpec[] = [
  ...
  },
  {
    ...
    tag: '6 signals',
    seat: 'COO · CFO · Owner',
    headline: 'Six theft signals, ticket-level.',
    intro: 'Six ticket-level signals: void after payment, cash-only voiders, comp abuse, promo stacking, discount after close, day-of-week patterns. Each name gets a composite risk score 0-100, sorted by severity.',
    catches: [
    ...
    output: 'Six color-coded signal cards · top-20 employee table sorted by composite risk score (red ≥ 50, orange ≥ 20).',
