...
export const SPECIALIST_PACKS: readonly SpecialistPack[] = [
  ...
  },
  {
    ...
    logicDomains: ['beverage', 'vendor-drift', 'uom-cost', 'pour-standards', 'fountain-bib', 'evidence'],
    publicTools: [
      'get_operator_system',
      'list_agent_jobs',
      'get_operator_logic',
  ...
  },
  {
    ...
    logicDomains: ['recipe-cost', 'uom-cost', 'pour-standards', 'fountain-bib', 'forensic-pnl', 'product-mix-pars', 'evidence'],
    publicTools: [
      'get_operator_system',
      'list_agent_jobs',
      'get_operator_logic',
    ...
    evidenceNotes: [
      ...
      'Fountain Pepsi: ask BIB syrup gal + $, gun mix ratio, cup liquid after ice — then mode=fountain_spirit_drink.',
